...
def performance(community, ip, port):
    while (1):
        ...
        if dato >= ready and CPU[0]:
            ...
            Grafica(int(timestamp), 'CPU', ready, sett, go)
        ...
        if dato >= ready and RAM[0]:
            ...
            Grafica(int(timestamp), 'RAM', ready, sett, go)
        ...
        if dato >= ready and DISK[0]:
            ...
            Grafica(int(timestamp), 'DISK', ready, sett, go)
            ...
            DISK[2] = False
            print('Alerta de DISK enviada ' + str(go))
            time.sleep(10)
